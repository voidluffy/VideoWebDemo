    ...
    public static class DemoData
    {
        public static List<Article> AllArticles
        {
            get
            {
                ...
                string dirPath = System.Web.HttpContext.Current.Request.PhysicalApplicationPath;// HttpContext.Current.Server.MapPath("../WebApplication/");
                if (Directory.Exists(dirPath))
                {
                    ...
                    foreach (FileInfo fileInfo in files)
                    {
                        ...
                        arts.Add(new Article
                        {
                            ...
                            Author = "Webdiyer",
                            Source = "吴起热线",
                            PubDate = new DateTime(2013, 7, 6, i, 0, 0)
                        });
                    }
